...
class Redis
{
  const BASE_PATH = '/www/html/laravel/html/blog';
  const CONFIG_FILE = '/config/redis.php';

  protected static $redis;

  public static function init(){
      self::$redis = new Client(require self::BASE_PATH.self::CONFIG_FILE);
      $redis = self::$redis;
      //$redis->set('test-library', 'predis');
      //$retval = $redis->get('test-library');
